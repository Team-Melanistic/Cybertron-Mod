...
public class TeleporterCybertron extends Teleporter {
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (l3 = l - short1; l3 <= l + short1; ++l3)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(l3, i2, l1) == CybertronMod.cybertron_portal)
                        {
                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == CybertronMod.cybertron_portal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == CybertronMod.cybertron_portal)
            {
                i4 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == CybertronMod.cybertron_portal)
            {
                i4 = 3;
            }
